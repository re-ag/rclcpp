...
public:
    ...
    RCLCPP_PUBLIC
    std::vector<std::string> get_src_tasks() const override;
    
    RCLCPP_PUBLIC
    std::string get_networking_topic() const override;
    ...
    RCLCPP_PUBLIC
    bool use_tcl_timer() const override;

    RCLCPP_PUBLIC
    bool use_net() const override;
    ...
    RCLCPP_PUBLIC
    void create_timing_headers() override;
...
private:
    ...
    // std::string src_task_;
    std::vector<std::string> src_tasks_;
    std::string networking_topic_;
};
