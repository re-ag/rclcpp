...
public:
    ...
    RCLCPP_PUBLIC
    virtual std::vector<std::string> get_src_tasks() const = 0;

    RCLCPP_PUBLIC
    virtual std::string get_networking_topic() const = 0;
    ...
    RCLCPP_PUBLIC
    virtual bool use_tcl_timer() const = 0;

    RCLCPP_PUBLIC
    virtual bool use_net() const = 0;
    ...
    RCLCPP_PUBLIC
    virtual void create_timing_headers() = 0;
