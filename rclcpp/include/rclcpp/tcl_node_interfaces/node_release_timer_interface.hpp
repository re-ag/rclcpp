...
public:
    ...
    // RCLCPP_PUBLIC
    // virtual void sleep(bool expired = false) = 0;

    RCLCPP_PUBLIC
    virtual int64_t sleep(bool second = false) = 0;
    ...
    RCLCPP_PUBLIC
    virtual std::chrono::nanoseconds get_phase_ns() const = 0;

    RCLCPP_PUBLIC
    virtual std::chrono::nanoseconds get_global_ref_time() const = 0;    
};
