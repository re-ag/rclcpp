...
public:
    ...
    // RCLCPP_PUBLIC
    // void sleep(bool expired=false) override;
    RCLCPP_PUBLIC
    int64_t sleep(bool second = false) override;
    ...
    RCLCPP_PUBLIC
    std::chrono::nanoseconds get_phase_ns() const override;
    
    RCLCPP_PUBLIC
    std::chrono::nanoseconds get_global_ref_time() const override;
